...
export default function HeroSection() {
    ...
    return (
        <div className="bg-gradient-to-r from-cyan-800 to-blue-800 h-screen landscape:portrait">
            ...
            {/* About Us */}
            <Element name='about' id='about' className='h-screen bg-gradient-to-r from-cyan-800 to-blue-800 h-screen'>
                <div className='pt-9'>
                    <h1 className=' text-center text-5xl font-bold mb-3 text-white'>About</h1>
                    ...
                    <div className=' mx-4 text-white'>
                        <h3 className='font-bold text-2xl mt-16 text-4xl mb-4'>Misi Perusahaan :</h3>
