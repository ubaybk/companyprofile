        ...
        <div className="bg-gradient-to-r from-cyan-800 to-blue-800 h-screen">
            ...
            <section
                ...
                <div
                    ...
                    <a target="_blank" className=" mr-6 text-neutral-600 dark:text-neutral-200" href="https://www.facebook.com/bayu.yupi?mibextid=ZbWKwL">
                            <svg
                        ...
                        <a target="_blank" className="mr-6 text-neutral-600 dark:text-neutral-200" href="https://www.instagram.com/ubaybk?utm_source=qr&amp;igsh=MWcyYXFlMHE0NG4xaw==">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-4 w-4"
                                fill="currentColor"
                        ...
                        <a target="_blank" className="text-neutral-600 dark:text-neutral-200" href="https://github.com/ubaybk">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-4 w-4"
                                fill="currentColor"
