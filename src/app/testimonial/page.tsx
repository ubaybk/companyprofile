    ...
    return (
      <div className="container my-24 mt-auto md:px-6 md:mt-3">
        ...
        <h2 className="text-center font-extrabold mb-3 text-4xl mt-2 sm:-mt-[46px] lg:text-7xl text-white">
          ...
          <button
            className=" absolute top-1/2 -translate-y-1/2 right-7 -mt-[150px] lg:mt-[80px] lg:right-[300px] z-[1] flex items-center justify-center bg-white bg-opacity-25 p-2 rounded-full text-neutral-600 dark:text-neutral-300 hover:text-neutral-800 dark:hover:text-neutral-100 transition-all duration-300 ease-in-out transform-gpu focus:outline-none"
            type="button"
            onClick={nextSlide}
          >
